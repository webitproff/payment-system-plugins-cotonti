...
$L['cfg_fisctax_params'] = 'Общая СН,Упрощенная СН (доходы),Упрощенная СН (доходы минус расходы),Единый налог на вмененный доход,Единый сельскохозяйственный налог,Патентная СН';
